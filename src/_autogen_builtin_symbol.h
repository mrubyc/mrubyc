...
static const char *builtin_symbols[] = {
  ...
  "encoding",		// MRBC_SYMID_encoding = 99(0x63)
  "end_with?",		// MRBC_SYMID_end_with_Q = 100(0x64)
  "erf",		// MRBC_SYMID_erf = 101(0x65)
  "erfc",		// MRBC_SYMID_erfc = 102(0x66)
  "exclude_end?",	// MRBC_SYMID_exclude_end_Q = 103(0x67)
  "exp",		// MRBC_SYMID_exp = 104(0x68)
  "find_index",		// MRBC_SYMID_find_index = 105(0x69)
  "first",		// MRBC_SYMID_first = 106(0x6a)
  "getbyte",		// MRBC_SYMID_getbyte = 107(0x6b)
  "has_key?",		// MRBC_SYMID_has_key_Q = 108(0x6c)
  "has_value?",		// MRBC_SYMID_has_value_Q = 109(0x6d)
  "hypot",		// MRBC_SYMID_hypot = 110(0x6e)
  "id2name",		// MRBC_SYMID_id2name = 111(0x6f)
  "include?",		// MRBC_SYMID_include_Q = 112(0x70)
  "index",		// MRBC_SYMID_index = 113(0x71)
  "initialize",		// MRBC_SYMID_initialize = 114(0x72)
  "inspect",		// MRBC_SYMID_inspect = 115(0x73)
  "instance_methods",	// MRBC_SYMID_instance_methods = 116(0x74)
  "instance_variables",	// MRBC_SYMID_instance_variables = 117(0x75)
  "intern",		// MRBC_SYMID_intern = 118(0x76)
  "is_a?",		// MRBC_SYMID_is_a_Q = 119(0x77)
  "join",		// MRBC_SYMID_join = 120(0x78)
  "key",		// MRBC_SYMID_key = 121(0x79)
  "keys",		// MRBC_SYMID_keys = 122(0x7a)
  "kind_of?",		// MRBC_SYMID_kind_of_Q = 123(0x7b)
  "last",		// MRBC_SYMID_last = 124(0x7c)
  "ldexp",		// MRBC_SYMID_ldexp = 125(0x7d)
  "length",		// MRBC_SYMID_length = 126(0x7e)
  "ljust",		// MRBC_SYMID_ljust = 127(0x7f)
  "log",		// MRBC_SYMID_log = 128(0x80)
  "log10",		// MRBC_SYMID_log10 = 129(0x81)
  "log2",		// MRBC_SYMID_log2 = 130(0x82)
  "loop",		// MRBC_SYMID_loop = 131(0x83)
  "lstrip",		// MRBC_SYMID_lstrip = 132(0x84)
  "lstrip!",		// MRBC_SYMID_lstrip_E = 133(0x85)
  "map",		// MRBC_SYMID_map = 134(0x86)
  "map!",		// MRBC_SYMID_map_E = 135(0x87)
  "max",		// MRBC_SYMID_max = 136(0x88)
  "memory_statistics",	// MRBC_SYMID_memory_statistics = 137(0x89)
  "merge",		// MRBC_SYMID_merge = 138(0x8a)
  "merge!",		// MRBC_SYMID_merge_E = 139(0x8b)
  "message",		// MRBC_SYMID_message = 140(0x8c)
  "min",		// MRBC_SYMID_min = 141(0x8d)
  "minmax",		// MRBC_SYMID_minmax = 142(0x8e)
  "new",		// MRBC_SYMID_new = 143(0x8f)
  "nil?",		// MRBC_SYMID_nil_Q = 144(0x90)
  "object_id",		// MRBC_SYMID_object_id = 145(0x91)
  "ord",		// MRBC_SYMID_ord = 146(0x92)
  "p",			// MRBC_SYMID_p = 147(0x93)
  "pop",		// MRBC_SYMID_pop = 148(0x94)
  "print",		// MRBC_SYMID_print = 149(0x95)
  "printf",		// MRBC_SYMID_printf = 150(0x96)
  "push",		// MRBC_SYMID_push = 151(0x97)
  "puts",		// MRBC_SYMID_puts = 152(0x98)
  "raise",		// MRBC_SYMID_raise = 153(0x99)
  "reject",		// MRBC_SYMID_reject = 154(0x9a)
  "reject!",		// MRBC_SYMID_reject_E = 155(0x9b)
  "rjust",		// MRBC_SYMID_rjust = 156(0x9c)
  "rstrip",		// MRBC_SYMID_rstrip = 157(0x9d)
  "rstrip!",		// MRBC_SYMID_rstrip_E = 158(0x9e)
  "shift",		// MRBC_SYMID_shift = 159(0x9f)
  "sin",		// MRBC_SYMID_sin = 160(0xa0)
  "sinh",		// MRBC_SYMID_sinh = 161(0xa1)
  "size",		// MRBC_SYMID_size = 162(0xa2)
  "slice!",		// MRBC_SYMID_slice_E = 163(0xa3)
  "sort",		// MRBC_SYMID_sort = 164(0xa4)
  "sort!",		// MRBC_SYMID_sort_E = 165(0xa5)
  "split",		// MRBC_SYMID_split = 166(0xa6)
  "sprintf",		// MRBC_SYMID_sprintf = 167(0xa7)
  "sqrt",		// MRBC_SYMID_sqrt = 168(0xa8)
  "start_with?",	// MRBC_SYMID_start_with_Q = 169(0xa9)
  "strip",		// MRBC_SYMID_strip = 170(0xaa)
  "strip!",		// MRBC_SYMID_strip_E = 171(0xab)
  "tan",		// MRBC_SYMID_tan = 172(0xac)
  "tanh",		// MRBC_SYMID_tanh = 173(0xad)
  "times",		// MRBC_SYMID_times = 174(0xae)
  "to_a",		// MRBC_SYMID_to_a = 175(0xaf)
  "to_f",		// MRBC_SYMID_to_f = 176(0xb0)
  "to_h",		// MRBC_SYMID_to_h = 177(0xb1)
  "to_i",		// MRBC_SYMID_to_i = 178(0xb2)
  "to_s",		// MRBC_SYMID_to_s = 179(0xb3)
  "to_sym",		// MRBC_SYMID_to_sym = 180(0xb4)
  "tr",			// MRBC_SYMID_tr = 181(0xb5)
  "tr!",		// MRBC_SYMID_tr_E = 182(0xb6)
  "unshift",		// MRBC_SYMID_unshift = 183(0xb7)
  "upcase",		// MRBC_SYMID_upcase = 184(0xb8)
  "upcase!",		// MRBC_SYMID_upcase_E = 185(0xb9)
  "upto",		// MRBC_SYMID_upto = 186(0xba)
  "utf8_size",		// MRBC_SYMID_utf8_size = 187(0xbb)
  "utf8_slice",		// MRBC_SYMID_utf8_slice = 188(0xbc)
  "values",		// MRBC_SYMID_values = 189(0xbd)
  "|",			// MRBC_SYMID_OR = 190(0xbe)
  "~",			// MRBC_SYMID_NEG = 191(0xbf)
};
#endif
...
enum {
  ...
  MRBC_SYMID_encoding = 99,
  MRBC_SYMID_end_with_Q = 100,
  MRBC_SYMID_erf = 101,
  MRBC_SYMID_erfc = 102,
  MRBC_SYMID_exclude_end_Q = 103,
  MRBC_SYMID_exp = 104,
  MRBC_SYMID_find_index = 105,
  MRBC_SYMID_first = 106,
  MRBC_SYMID_getbyte = 107,
  MRBC_SYMID_has_key_Q = 108,
  MRBC_SYMID_has_value_Q = 109,
  MRBC_SYMID_hypot = 110,
  MRBC_SYMID_id2name = 111,
  MRBC_SYMID_include_Q = 112,
  MRBC_SYMID_index = 113,
  MRBC_SYMID_initialize = 114,
  MRBC_SYMID_inspect = 115,
  MRBC_SYMID_instance_methods = 116,
  MRBC_SYMID_instance_variables = 117,
  MRBC_SYMID_intern = 118,
  MRBC_SYMID_is_a_Q = 119,
  MRBC_SYMID_join = 120,
  MRBC_SYMID_key = 121,
  MRBC_SYMID_keys = 122,
  MRBC_SYMID_kind_of_Q = 123,
  MRBC_SYMID_last = 124,
  MRBC_SYMID_ldexp = 125,
  MRBC_SYMID_length = 126,
  MRBC_SYMID_ljust = 127,
  MRBC_SYMID_log = 128,
  MRBC_SYMID_log10 = 129,
  MRBC_SYMID_log2 = 130,
  MRBC_SYMID_loop = 131,
  MRBC_SYMID_lstrip = 132,
  MRBC_SYMID_lstrip_E = 133,
  MRBC_SYMID_map = 134,
  MRBC_SYMID_map_E = 135,
  MRBC_SYMID_max = 136,
  MRBC_SYMID_memory_statistics = 137,
  MRBC_SYMID_merge = 138,
  MRBC_SYMID_merge_E = 139,
  MRBC_SYMID_message = 140,
  MRBC_SYMID_min = 141,
  MRBC_SYMID_minmax = 142,
  MRBC_SYMID_new = 143,
  MRBC_SYMID_nil_Q = 144,
  MRBC_SYMID_object_id = 145,
  MRBC_SYMID_ord = 146,
  MRBC_SYMID_p = 147,
  MRBC_SYMID_pop = 148,
  ...
  MRBC_SYMID_push = 151,
  MRBC_SYMID_puts = 152,
  MRBC_SYMID_raise = 153,
  MRBC_SYMID_reject = 154,
  MRBC_SYMID_reject_E = 155,
  MRBC_SYMID_rjust = 156,
  MRBC_SYMID_rstrip = 157,
  MRBC_SYMID_rstrip_E = 158,
  MRBC_SYMID_shift = 159,
  MRBC_SYMID_sin = 160,
  MRBC_SYMID_sinh = 161,
  MRBC_SYMID_size = 162,
  MRBC_SYMID_slice_E = 163,
  MRBC_SYMID_sort = 164,
  MRBC_SYMID_sort_E = 165,
  MRBC_SYMID_split = 166,
  MRBC_SYMID_sprintf = 167,
  MRBC_SYMID_sqrt = 168,
  MRBC_SYMID_start_with_Q = 169,
  MRBC_SYMID_strip = 170,
  MRBC_SYMID_strip_E = 171,
  MRBC_SYMID_tan = 172,
  MRBC_SYMID_tanh = 173,
  MRBC_SYMID_times = 174,
  MRBC_SYMID_to_a = 175,
  MRBC_SYMID_to_f = 176,
  MRBC_SYMID_to_h = 177,
  MRBC_SYMID_to_i = 178,
  MRBC_SYMID_to_s = 179,
  MRBC_SYMID_to_sym = 180,
  MRBC_SYMID_tr = 181,
  MRBC_SYMID_tr_E = 182,
  MRBC_SYMID_unshift = 183,
  MRBC_SYMID_upcase = 184,
  MRBC_SYMID_upcase_E = 185,
  MRBC_SYMID_upto = 186,
  MRBC_SYMID_utf8_size = 187,
  MRBC_SYMID_utf8_slice = 188,
  MRBC_SYMID_values = 189,
  MRBC_SYMID_OR = 190,
  MRBC_SYMID_NEG = 191,
};
